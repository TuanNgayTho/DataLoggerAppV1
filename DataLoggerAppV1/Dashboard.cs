...
namespace DataLoggerAppV1
{
    public partial class Dashboard : Form
    {
        ...
        private void ConnectToPlc()
        {
                ...
                while (true)
                {
                    ...
                    while (true)
                    {
                        try
                        {
                            if (MainForm.isConnect == false)
                            {
                                MessageBox.Show("Error: " + MainForm.plc.LastErrorCode + "\n" + MainForm.plc.LastErrorString);
                                break;
                            }
                            else
                            {
                                ...
                                Invoke(new Action(() =>
                                {
                                    lblAiDataCh0.Text = Convert.ToString(Convert.ToInt32(MainForm.DataAi0 * 100) / 100F);
                                    lblAiDataCh1.Text = Convert.ToString(Convert.ToInt32(MainForm.DataAi1 * 100) / 100F);
                                    lblAiDataCh2.Text = Convert.ToString(Convert.ToInt32(MainForm.DataAi2 * 100) / 100F);
                                    lblAiDataCh3.Text = Convert.ToString(Convert.ToInt32(MainForm.DataAi3 * 100) / 100F);
                                    lblAiDataCh4.Text = Convert.ToString(Convert.ToInt32(MainForm.DataAi4 * 100) / 100F);
                                    lblAiDataCh5.Text = Convert.ToString(Convert.ToInt32(MainForm.DataAi5 * 100) / 100F);
                                    lblAiDataCh6.Text = Convert.ToString(Convert.ToInt32(MainForm.DataAi6 * 100) / 100F);
                                    lblAiDataCh7.Text = Convert.ToString(Convert.ToInt32(MainForm.DataAi7 * 100) / 100F);
                                ...
                                //MainForm.plc.ReadClass(DbSettingData, 1);
                                //Invoke(new Action(() =>
                                //{
                                ...
                                //MainForm.plc.ReadClass(DbReadBool, 13);
                                //Invoke(new Action(() =>
                                //{
                                //    //Button Status
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                MainForm.plc.Write("DB13.DBX0.0", true);
            }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                MainForm.plc.Write("DB13.DBX0.1", true);
            }
            catch (Exception exception)
            {
            }
        ...
        private void btnManAuto_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                MainForm.plc.Write("DB3.DBX1.0", true);
            }
            catch (Exception exception)
            {
            }
        ...
        private void btnStream3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                 MainForm.plc.Write("DB13.DBX0.2", true);
            }
            catch (Exception exception)
            {
            }
        ...
        private void btnAutoMode_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                 MainForm.plc.Write("DB3.DBX1.1", true);
            }
            catch (Exception exception)
            {
            }
        ...
        private void btnStop_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                  MainForm.plc.Write("DB3.DBX0.7", true);
            }
            catch (Exception exception)
            {
            }
        ...
        private void btnSart_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                 MainForm.plc.Write("DB3.DBX0.6", true);
            }
            catch (Exception exception)
            {
            }
