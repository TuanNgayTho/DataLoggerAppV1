                    ...
                    try
                    {
                        ...
                        else
                        {
                            ...
                            Invoke(new Action(() =>
                            {
                                ...
                                barStream1.Value = DbAiData.AiPercent0;
                                barStream2.Value = DbAiData.AiPercent1;
                                barStream3.Value = DbAiData.AiPercent2;
                                barStream4.Value = DbAiData.AiPercent3;
                                barStream5.Value = DbAiData.AiPercent4;
                                barStream6.Value = DbAiData.AiPercent5;
                                barStream7.Value = DbAiData.AiPercent6;
                                barStream8.Value = DbAiData.AiPercent7;
                            }));
